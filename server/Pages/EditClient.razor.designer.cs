...
{
    public partial class EditClientComponent : ComponentBase
    {
        ...
        protected async System.Threading.Tasks.Task Form0Submit(SimpleCarRepair.Models.SimpleCarRepairDb.Client args)
        {
            try
            {
                var simpleCarRepairDbUpdateClientResult = await SimpleCarRepairDb.UpdateClient(Id, client);
                DialogService.Close(client);
            }
            catch (System.Exception simpleCarRepairDbUpdateClientException)
            {
