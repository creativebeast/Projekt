...
using SimpleCarRepair.Authentication;
using Radzen;
namespace SimpleCarRepair
{
    public partial class Startup
    {
        ...
        public void ConfigureServices(IServiceCollection services)
        {
            ...
            {
                options.UseSqlServer(Configuration.GetConnectionString("SimpleCarRepairDBConnection"));
            ...
            services.AddScoped<SimpleCarRepairDbService>();

            services.AddDbContext<SimpleCarRepair.Data.SimpleCarRepairDbContext>(options =>
            {
              options.UseSqlServer(Configuration.GetConnectionString("SimpleCarRepairDBConnection"));
            });
